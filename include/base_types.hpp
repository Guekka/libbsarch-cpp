...
public:
    ...
    extracted_data(extracted_data &&other) noexcept;

    extracted_data &operator=(const extracted_data &) = delete;
    extracted_data &operator=(extracted_data &&other);
...
public:
    ...
    bsa_entry_list_wrapper(bsa_entry_list_wrapper &&) noexcept;
...
public:
    ...
    bsa_wrapper(bsa_wrapper &&) noexcept;
